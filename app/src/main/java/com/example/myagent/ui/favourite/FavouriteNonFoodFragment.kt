 ...
 * Use the [FavouriteNonFoodFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FavouriteNonFoodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View=inflater.inflate(R.layout.fragment_favourite_non_food, container, false)
        return view
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val recyclerView=view.findViewById<RecyclerView>(R.id.recycler_view_favourite_non_food)
