 ...
 * Use the [FavouriteFoodFragment.newInstance] factory method to
...
class FavouriteFoodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View=inflater.inflate(R.layout.fragment_favourite_food, container, false)
        return view
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val recyclerview=view.findViewById<RecyclerView>(R.id.recycler_view_favourite_food)
